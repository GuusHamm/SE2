...
namespace W8
{
        ...
        {
            public delegate void CompleteMessageHandler(string message);
            public event CompleteMessageHandler MessageComplete;
            ...
            public void Append(String data)
            {
                ...
                while (CompleteMessage())
                {
                    ...
                    string message = FindAndRemoveNextMessage();
                    if (message != null)
                    {
