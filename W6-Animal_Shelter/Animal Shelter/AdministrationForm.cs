...
namespace AnimalShelter
{
    public partial class AdministrationForm : Form
    {
        ...
        public AdministrationForm()
        {
            ...
            animals.Add(new Cat("00001", new SimpleDate(02, 12, 1996), "Guus", "Verveling",true,MyEnum.Male));
            animals.Add(new Cat("00002", new SimpleDate(06, 10, 1995), "Robin", "Grammar Nazi", false,MyEnum.Female));

            animals.Add(new Dog("00003", new SimpleDate(20, 04, 2000), "Snoop", new SimpleDate(17, 03, 2015), true,MyEnum.Female));
            animals.Add(new Dog("00004", new SimpleDate(20, 02, 2015), "Doge", new SimpleDate(18, 03, 2015),false, MyEnum.Male));
                ...
                if (available)
                    {
                        ...
                        if (animalTypeComboBox.SelectedItem == "Cat")
                        {
                            if (cbGender.SelectedItem == "Male")
                            {
                                ...
                                tbNaam.Text, tbAnimalSpecific.Text, cbReserved.Checked, MyEnum.Male));
                            }
                            if (cbGender.SelectedItem == "Female")
                            {
                                animals.Add(new Cat(tbChip.Text,
                                new SimpleDate(dtpBirthday.Value.Day, dtpBirthday.Value.Month, dtpBirthday.Value.Year),
                                tbNaam.Text, tbAnimalSpecific.Text, cbReserved.Checked, MyEnum.Female));
                            }
                        ...
                        {
                            animals.Add(new Dog(tbChip.Text,new SimpleDate(dtpBirthday.Value.Day, dtpBirthday.Value.Month, dtpBirthday.Value.Year),
                                tbNaam.Text,new SimpleDate(dtpAnimalSpecific.Value.Day, dtpAnimalSpecific.Value.Month,
                                    dtpAnimalSpecific.Value.Year),cbReserved.Checked, MyEnum.Male));
                        }
                        if (cbGender.SelectedItem == "Female")
                        {
                             animals.Add(new Dog(tbChip.Text,
                                ...
                                new SimpleDate(dtpAnimalSpecific.Value.Day, dtpAnimalSpecific.Value.Month,
                                    dtpAnimalSpecific.Value.Year), cbReserved.Checked, MyEnum.Female));
                        }
