...
namespace AnimalShelter
{
    ...
    class Cat : Animal
    {
        ...
        public Cat(string chipRegistrationNumber, SimpleDate dateOfBirth,
            string name, string badHabits, bool isReserved, string gender)
            : base(chipRegistrationNumber, dateOfBirth, name, gender)
        {

            this.badHabits = badHabits;
            base.IsReserved = isReserved;
            Prijsbaar();
        ...
        public override void Prijsbaar()
        {
            base.Prijs = 60 - badHabits.Length;
