...
namespace AnimalShelter
{
    ...
    [Serializable]
    internal abstract class Animal : IPrijsbaar
   {
    /// <summary>
    ...
    public Animal(string chipRegistrationNumber, SimpleDate dateOfBirth, string name, string gender)
    {
    ...
    public override string ToString()
    {
        ...
        public abstract void Prijsbaar();
   }
}
